...
namespace passthemessage
{
    ...
    {
        Task PublishEventsAsync(IList<EventGridMessage> data);
    }
     public class EventGridService : IEventGridService
    {
        ...
        public async Task PublishEventsAsync(IList<EventGridMessage> data) =>
            await _eventGridClient.PublishEventsAsync(_topicHostname, GetEventGridEvents(data));

        private IList<EventGridEvent> GetEventGridEvents(IList<EventGridMessage> data)
        {
